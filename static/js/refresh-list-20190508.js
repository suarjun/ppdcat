function gotoPage(a, page, policy_name, start_date, end_date, total_page)
    ...
    function(data,status){
        ...
        record_list = data_json[k]["record_list"]
        policy_name = ", '"+data_json[k]["policy_name"]+"'";
        start_date = ", '"+data_json[k]["start_date"]+"'";
        end_date = ", '"+data_json[k]["end_date"]+"'";
        current_page = data_json[k]["current_page"];
        total_page = data_json[k]["total_page"];
...
function replaceGagination(policy_name, start_date, end_date, current_page, total_page)
    ...
    if (current_page == total_page)
        ...
        {pagination_html += ('<li><a href="javascript:void(0);" onclick="gotoPage(this,'+(current_page+1)+policy_name+start_date+end_date+')">&raquo;</a></li>');}
